...
using MartiX.WebApi.Template.Web.Feature.Product.GetById;
using MartiX.WebApi.Template.Web.Feature.Product.List;
using CartGetByIdRequest = MartiX.WebApi.Template.Web.Feature.Cart.GetById.GetCartRequest;

namespace MartiX.WebApi.Template.Web.Tests.Feature.EndpointPaths;

...
- Root release and publish automation for the `MartiX.Dotnet.Templates` package, when maintained, belongs at the repository root and must stay separate from the scaffolded generated-repo release baseline under `templates\MartiX.WebApi.Template\`.
